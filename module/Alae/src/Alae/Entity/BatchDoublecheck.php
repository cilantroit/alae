 ...
 * @ORM\Entity
 */
class BatchDoublecheck
{

    /**
     * @var integer
     *
     * @ORM\Column(name="pk_batch_doublecheck", type="bigint", nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="IDENTITY")
     */
    protected $pkBatchDoublecheck;
    ...
    public function getPkBatchDoubleCheck()
    {
        return $this->pkBatchDoublecheck;
    }

    public function setPkBatchDoubleCheck($pkBatchDoublecheck)
    {
        $this->pkBatchDoublecheck = $pkBatchDoublecheck;
    }
