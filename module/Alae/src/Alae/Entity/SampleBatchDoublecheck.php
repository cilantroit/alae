...
/**
 * SampleBatchDoublecheck
 *
 * @ORM\Table(name="alae_batch_doublecheck", indexes={@ORM\Index(name="fk_batch_doublecheck", columns={"fk_batch_doublecheck"})})
 * @ORM\Entity
 */
class SampleBatchDoublecheck
{

    /**
     * @var integer
     *
     * @ORM\Column(name="pk_sample_batch_doublecheck", type="bigint", nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="IDENTITY")
     */
    protected $pkSampleBatchDoublecheck;
    
    /**
     * @var \Alae\Entity\BatchDoublecheck
     *
     * @ORM\ManyToOne(targetEntity="Alae\Entity\BatchDoublecheck")
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="fk_batch_Doublecheck", referencedColumnName="pk_batch_doublecheck")
     * })
     */
    protected $fkBatchDoublecheck;
    ...
    public function getPkSampleBatchDoubleCheck()
    {
        return $this->pkSampleBatchDoublecheck;
    }

    public function setPkSampleBatchDoublecheck($pkSampleBatchDoublecheck)
    {
        $this->pkSampleBatchDoublecheck = $pkSampleBatchDoublecheck;
    }
    
        public function getfkBatchDoubleCheck()
    {
        return $this->fkBatchDoublecheck;
    }

    public function setfkBatchDoubleCheck(\Alae\Entity\BatchDoublecheck $fkBatchDoublecheck)
    {
        $this->fkBatchDoublecheck = $fkBatchDoublecheck;
    }
    ...
    public function setfkSampleBatch($fkSampleBatch)
    {
